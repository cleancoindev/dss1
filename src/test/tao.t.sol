...
contract TaoTest is DSTest {
    ...
    function createToken() internal returns (Tao) {
        return new Tao(99);
    }
    ...
    function testTaotaoAddress() public {
        //The tao address generated by hevm
